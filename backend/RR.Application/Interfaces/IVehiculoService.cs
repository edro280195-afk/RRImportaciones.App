...
{
    Task<PagedResult<VehiculoListDto>> GetListAsync(string? search, Guid? clienteId, string? clienteNombre, Guid? marcaId, int? annoMin, int? annoMax, bool? enPatio, string? orderBy, string? orderDir, int page = 1, int pageSize = 20);

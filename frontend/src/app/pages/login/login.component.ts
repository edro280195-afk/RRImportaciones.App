        ...
        <div class="login-card" [class.pin-active]="mode() === 'pin' && step() === 'credentials'">
          ...
          @if (sessionExpiredToast()) {
            <div class="alert alert-warn" role="alert">
              ...
              <button
                class="alert-close"
                (click)="sessionExpiredToast.set(false)"
                aria-label="Cerrar"
              >
          ...
          <div class="steps-viewport">
            <div class="steps-wrapper">
              ...
              <div
                class="step-pane step-pane-credentials"
                [class.active]="step() === 'credentials'"
              >
              ...
              <div class="step-pane step-pane-pin-setup" [class.active]="step() === 'pin-setup'">
                  ...
                  <div class="pin-setup-slider">
                    ...
                    <div class="pin-setup-pane" [class.active]="pinSetupStep() === 'new'">
                      ...
                      <div class="passcode-dots-wrapper">
                        <span
                          class="label-field text-center block mb-2"
                    ...
                    <div class="pin-setup-pane" [class.active]="pinSetupStep() === 'confirm'">
                      ...
                      <div class="passcode-dots-wrapper">
                        <span
                          class="label-field text-center block mb-2"
                          style="display: block; text-align: center; margin-bottom: 6px;"
                          >Confirma tu PIN</span
                        >
                        <div class="passcode-dots">
                          <div
                            class="dot"
                            [class.filled]="pinConfirm.length > 0"
                            [class.dot-error]="
                              pinNew.length === 6 &&
                              pinConfirm.length === 6 &&
                              pinNew !== pinConfirm
                          ...
                          <div
                            class="dot"
                            [class.filled]="pinConfirm.length > 1"
                            [class.dot-error]="
                              pinNew.length === 6 &&
                              pinConfirm.length === 6 &&
                              pinNew !== pinConfirm
                          ...
                          <div
                            class="dot"
                            [class.filled]="pinConfirm.length > 2"
                            [class.dot-error]="
                              pinNew.length === 6 &&
                              pinConfirm.length === 6 &&
                              pinNew !== pinConfirm
                          ...
                          <div
                            class="dot"
                            [class.filled]="pinConfirm.length > 3"
                            [class.dot-error]="
                              pinNew.length === 6 &&
                              pinConfirm.length === 6 &&
                              pinNew !== pinConfirm
                          ...
                          <div
                            class="dot"
                            [class.filled]="pinConfirm.length > 4"
                            [class.dot-error]="
                              pinNew.length === 6 &&
                              pinConfirm.length === 6 &&
                              pinNew !== pinConfirm
                          ...
                          <div
                            class="dot"
                            [class.filled]="pinConfirm.length > 5"
                            [class.dot-error]="
                              pinNew.length === 6 &&
                              pinConfirm.length === 6 &&
                              pinNew !== pinConfirm
                        ...
                        @if (
                          pinNew.length === 6 && pinConfirm.length === 6 && pinNew !== pinConfirm
                        ) {
                          <p class="hint-error text-center" style="text-align: center;">
                ...
                <div class="ios-keypad-container">
                  <div class="ios-keypad">
                    ...
                    <button
                      type="button"
                      class="keypad-key key-backspace"
                      (click)="onKeypadBackspace()"
              ...
              <div class="step-pane step-pane-forgot-pin" [class.active]="step() === 'forgot-pin'">
                <div class="pane-header">
                  ...
                  <p class="step-sub">
                    Escribe tu usuario y notificaremos a un administrador para que te asigne uno
                    nuevo.
                  </p>
                </div>
                ...
                @if (forgotSent()) {
                  <div class="alert alert-ok animate-in" role="status">
                    ...
                    <span
                      >Solicitud enviada. Un administrador te asignará un PIN nuevo pronto.</span
                    >
                  </div>
                } @else {
          ...
          <div class="pin-overlay" [class.active]="mode() === 'pin' && step() === 'credentials'">
            ...
            @if (error() && step() === 'credentials' && mode() === 'pin') {
              <div
                ...
                role="alert"
                style="margin: 4px 0; padding: 10px 12px; font-size: 12px; width: 100%;"
              >
                <svg
                  class="alert-icon"
                  fill="none"
            ...
            <button type="button" class="forgot-pin-link" (click)="goForgotPin()">
              ¿Olvidaste tu PIN?
            </button>
          </div>
        </div>
...
export class LoginComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private animate = (): void => {
    ...
    this.orbs.forEach(orb => {
      ...
      const grad = this.ctx!.createRadialGradient(drawX, drawY, 0, drawX, drawY, orb.radius);
  ...
  onSubmit(): void {
    ...
    const u = this.username.trim();
    if (!u) {
      this.showError('Ingresa tu nombre de usuario');
      return;
    }
    ...
    if (this.mode() === 'password') {
      ...
      if (this.pinLogin.length !== 6) {
        this.showError('Ingresa los 6 dígitos de tu PIN');
        return;
      }
      this.loading.set(true);

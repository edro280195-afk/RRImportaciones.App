...
@Component({
  ...
  template: `
    <div class="space-y-5">
      ...
      @if (showModal()) {
        <div class="fixed inset-0 z-50 flex items-start justify-center bg-black/40 p-4 backdrop-blur-sm overflow-y-auto" (click)="closeModal()">
          <form class="w-full max-w-2xl rounded-2xl bg-white p-6 shadow-2xl my-auto" (click)="$event.stopPropagation()" (ngSubmit)="save()">

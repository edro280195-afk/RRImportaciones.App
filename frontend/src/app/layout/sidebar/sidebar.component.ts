...
@Component({
  ...
  template: `
    ...
    >
      <!-- Brand header + toggle -->
      <div
        class="flex items-center px-4 pt-5 pb-4 border-b border-white/[0.06]"
      ...
      >
        ...
        >
          <svg
            ...
            stroke="currentColor"
            viewBox="0 0 24 24"
            class="w-3.5 h-3.5 stroke-2 text-white"
          >
            @if (isMobile()) {
        ...
        @if (showLabels()) {
          <div class="overflow-hidden ml-2.5">
            <p
              class="text-white font-semibold text-[13px] leading-none tracking-[-0.3px] whitespace-nowrap"
            >
              Importaciones
            </p>
          </div>
      ...
      <nav class="flex-1 px-2.5 py-3 overflow-y-auto">
        @for (group of menuGroups(); track group.label; let gi = $index) {
          <div class="mb-4" [style.animationDelay]="gi * 40 + 'ms'">
            @if (showLabels()) {
              <p
                class="text-[10px] font-semibold text-white/25 uppercase tracking-[1px] px-2.5 mb-1 overflow-hidden whitespace-nowrap"
              >
                {{ group.label }}
              </p>
            }
      ...
      <div class="p-2.5 border-t border-white/[0.06]">
        ...
        >
          <div
            class="w-[30px] h-[30px] rounded-full bg-[#C61D26] flex items-center justify-center text-white font-semibold text-[10px] shrink-0 shadow-[0_0_0_2px_rgba(198,29,38,0.3)]"
          >
            {{ initials() }}
          </div>
          @if (showLabels()) {
            <div class="flex-1 min-w-0 overflow-hidden">
              <p
                class="text-white/80 text-[12.5px] font-medium truncate leading-none mb-0.5 group-hover:text-white transition-colors duration-150"
              >
                {{ displayName() }}
              </p>
...
export class SidebarComponent implements OnInit {
  ...
  private buildMenu(): MenuGroup[] {
    ...
    const icons = {
      ...
      vehicles: this.svg(
        s('M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z') +
          s('M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10l2-1m8 1H9m4 0h2m4-8h-4l-1-4H7l-1 3H2')
      ),
      tramites: this.svg(
        s(
      ...
      pagos: this.svg(
        s('M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z')
      ),
      gastos: this.svg(
        s(
      ...
      reportes: this.svg(
        s('M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z') +
          s('M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z')
      ),
      marcas: this.svg(
        s(
      ...
      tramitadores: this.svg(
        s('M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z')
      ),
      personal: this.svg(
        s(
      ...
      importador: this.svg(
        s('M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1M12 12V4m0 0l-4 4m4-4l4 4') + s('M4 12h16')
      ),
      ...
      catalogo: this.svg(s('M4 6h16M4 10h16M4 14h8M4 18h6') + s('M16 13l2 2 4-4')),
      manual: this.svg(
        s(
    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          {
            label: 'Importador',
            icon: icons.importador,
            route: '/admin/importador',
            permiso: 'ADMIN_IMPORTADOR',
          },
          {
            label: 'Plantillas',
      ...
      },
      {
        label: 'Ayuda',
        items: [
          { label: 'Manual de usuario', icon: icons.manual, route: '/manual', permiso: null },
        ],
      },
    ];
  }
